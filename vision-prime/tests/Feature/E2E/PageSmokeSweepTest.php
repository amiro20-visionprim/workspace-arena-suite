...
class PageSmokeSweepTest extends TestCase
{
    ...
    public function test_every_public_and_app_page_opens_for_real_users(): void
    {
        ...
        foreach (Route::getRoutes() as $route) {
            ...
            if (! (str_starts_with($uri, 'app/') || str_starts_with($uri, 'marketing') || in_array($uri, ['login', 'register', 'forgot-password', 'for-agencies', 'for-ecommerce', 'for-clinics', 'for-education', 'for-hospitality', 'case-study', 'product', 'app/training/glossary', 'features', 'pricing', 'demo', 'security', 'about', 'contact', 'assistant/knowledge'], true))) {
                continue;
            }
